...
local hotkeys_popup = require('awful.hotkeys_popup') -- Enable hotkeys help widget
...
screen.connect_signal('property::geometry', functions.screen.set_wallpaper)

awful.screen.connect_for_each_screen(functions.screen.connect_for_each_screen)
-- }}}
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey, }, 'Left', functions.tag.view_next(true, -1),
		{ description = 'view non-empty previous tag', group = 'tag' }),
	awful.key({ modkey, }, 'Right', functions.tag.view_next(true, 1),
		{ description = 'view non-empty next tag', group = 'tag' }),
	awful.key({ modkey, 'Control' }, 'Left', functions.tag.view_next(false, -1),
		{ description = 'view previous tag', group = 'tag' }),
	awful.key({ modkey, 'Control' }, 'Right', functions.tag.view_next(false, 1),
