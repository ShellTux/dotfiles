...
function em:get_bindings()
	local bindings = {
		...
		{ 'pgup',       function() self:change_selected_index(-options.lines_to_show) end },
		{ 'pgdwn',      function() self:change_selected_index(options.lines_to_show) end },
